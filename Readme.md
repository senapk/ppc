...
Para provimento de rede de comunicação e acesso à internet, todos os blocos contam com uma sala de telemática onde estão situados os equipamentos de comunicação que interligam os blocos.

Salienta-se que todos os blocos que apresentam mais de um pavimento possuem plataforma elevatória.
O campus conta com 266 equipamentos eletrônicos para atender a demanda interna, sendo estes: 28 notebooks; 33 projetores; 213 desktops; 06 máquinas servidoras para telemática; 16 aparelhos telefônicos VOIPs; 03 nobreaks. Os equipamentos de TI estão distribuídos em salas administrativas e nos laboratórios apresentados adiante. 

As seções a seguir descrevem os vários ambientes e condições estruturais que contribuem diretamente para a formação do aluno.

### Salas de Aula
Considerando-se os blocos didáticos I a IV, o campus disponibiliza 17 (dezessete) salas de aula, onde ocorrem prioritariamente as aulas teóricas. Algumas salas comportam confortavelmente até 60 alunos e outras, 30, de maneira a atender às necessidades institucionais e do curso. As salas de aula passam por limpeza diária e manutenção periódica, além da disponibilidade de recursos tecnológicos adequados às atividades desenvolvidas: a maior parte dispõe de projetores digitais instalados e duas delas possuem sistema de som integrado. As cadeiras podem ser dispostas em diferentes configurações, oportunizando distintas situações de ensino-aprendizagem. Não raro, os alunos ocupam as paredes das salas com painéis e cartazes para auxiliar no planejamento e acompanhamento dos projetos desenvolvidos durante as disciplinas.

Outras atividades didáticas podem acontecer na Sala de Seminários (bloco administrativo), sala multiuso, sala de videoconferência, além de nos laboratórios, especificados a seguir.

### Laboratórios
O Campus da UFC em Quixadá oferece estrutura de laboratórios compreendendo principalmente o uso de ferramentas computacionais. No total, há sete laboratórios de computadores para uso didático, todos com projetores digitais. Dos sete laboratórios, seis são destinados continuamente a aulas e um é considerado como estrutura de apoio, no qual o corpo discente pode realizar estudos, pesquisas e desenvolvimento de trabalhos em horários extraclasse. Os laboratórios destinados às aulas possuem capacidade variada, possuem acesso à rede WiFi e estão discriminados na tabela.

Nome do Laboratório |Equipamentos, ferramentas e recursos disponíveis | Área física
-----------------------|-------------------------------------------------|------------
Laboratório 1 - Bloco 1| 12 computadores com 2 GB de memória RAM e processador Intel Core 2 Duo |66.59 m2
Laboratório 2 - Bloco 1| 20 computadores com 4 GB de memória RAM e processador Intel Core i5    |66.59 m2
Laboratório 3 - Bloco 1| 27 computadores com 4 GB de memória RAM e processador Intel Core i5    |66.59 m2
Laboratório 4 - Bloco 1| 28 computadores com 8 GB de memória RAM e processador Intel Core i7    |66.59 m2
Laboratório 5 - Bloco 4| 25 computadores com 8 GB de memória RAM e processador Intel Core i7    |66.59 m2
Laboratório 6 - Bloco 3| 15 computadores com 8 GB de memória RAM e processador Intel Core i7    |66.59 m2
Laboratório 7 - Bloco 3| 13 computadores com 8 GB de memória RAM e processador Intel Core i7    |66.59 m2

Os computadores são disponibilizados com acesso à internet, além de ferramentas de criação e execução apropriadas para os ambientes de aprendizado, contando com softwares open source condizentes com as práticas efetivadas no mercado de trabalho e destinados a procedimentos como ambientes de desenvolvimento e programação de sistemas, criação de firmwares, comunicação com microcontroladores, além de pacotes de escritório. As estações de trabalho nos laboratórios são configuradas em dual boot, possuindo Windows e Linux como sistemas operacionais, de modo que alunos e professores possam lidar com ambientes de acordo com as necessidades de aprendizado.
